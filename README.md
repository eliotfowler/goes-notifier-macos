...
Periodically check for available GOES appointments and be notified if one opens up sooner than the one you've scheduled.

### Preface

As you may know, getting an appointment for your global entry interview within a reasonable amount of time can be challenging. Some people have reported that it's possible to go to the interview location and walk-in for an appointment with ease. If you have the time, it may be worth giving that a shot.

If you are conditionally approved for your global entry appointment, have a tentative interview scheduled (please do this), don't have time or interest in attempting a walk-in appointment, and there isn't one currently available as soon as you'd like, this tool could help. You can simply run it from your terminal and leave it running. If it finds an appointment sooner than the one you've got, it will let you know.

There exists a python library that does basically this same thing, but it's a bit more complicated and running it repeatedly requires setting a crontab so I decided to make this one. If you prefer python, or want a tool that can email you when an appointment opens up, check out [Drewster727/goes-notify](https://github.com/Drewster727/goes-notify).

### Usage:

After cloning this repository, simply run:
```
ruby goes-notifier-macos.rb [your appointment date (2018-10-11)] [your location id] <check interval=600>
```

Example: `ruby goes-notifier-macos.rb 2018-10-11 5446`

This would check for any appointments available before October 11, 2018 and notify you if one opens up.


### GOES Center Codes
from [Drewster727/goes-notify](https://github.com/Drewster727/goes-notify)
